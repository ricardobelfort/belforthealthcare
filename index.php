...
<body>
    ...
    <header class="main_header container bg-white" id="home">
        <div class="content-no">
            ...
            <ul class="main_nav right">
                ...
                <li><a href="#about" title="">Sobre Nós</a></li>
                <li><a href="#objetivos" title="">Objetivos</a></li>
                <li><a href="#produtos" title="">Produtos</a></li>
    ...
    <section class="container bloco bg-about" id="produtos">
        <div class="content-medium">
            <header class="sectitle">
